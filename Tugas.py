...
for x, row in df.iterrows():
    df.at[x, "Gaji naik 5%"] = row["Gaji"] * 1.05

# Pertanyaan 2:
# Setelah perubahan dilakukan, tampilkan DataFrame yang sudah diperbarui dan berikan ringkasan perubahan yang telah terjadi.
print("\nHasil data setelah gaji naik 5%:")
print(df)
print("\nRingkasan perubahan")
...
for x, row in df.iterrows():
    df.at[x, "Gaji naik 2%"] = row["Gaji"] * 1.02 if row["Usia"] > 30 else row["Gaji"]

# Pertanyaan 4:
# Tampilkan DataFrame yang sudah diperbarui setelah peningkatan gaji tambahan dan berikan ringkasan hasilnya.
print("\nHasil data setelah gaji naik 2% (usia diatas > 30):")
print(df)
print("\nRingkasan perubahan")
ringkasan = df.describe()
print(ringkasan)
